  ...
  <div class="container">
    <section>
      <div class="page-header" id="agregar-Pregunta-Frecuente">
        ...
        <div class="col-lg-8">
            <form action="common/valid-agregar-pregunta-frecuente.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <label for="user-name" class="col-lg-2 control-label">Pregunta</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" id="pregunta" placeholder="Inserte la Pregunta Frecuente">
                </div>
              </div><!-- End form group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <textarea name="user-message" id="respuesta" class="form-control" 
